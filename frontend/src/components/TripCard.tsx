...
const TripCard: React.FC<TripCardProps> = ({ trip }) => {
  ...
  return (
    <Link to={`/trips/${trip.id}`} className="block">
      <div className="h-[190px] bg-gray-800 p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-700 flex justify-between cursor-pointer">
        <div>
