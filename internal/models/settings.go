...
type Settings struct {
	...
	SeatReclineAngle       *float32   `json:"seat_recline_angle,omitempty" validate:"omitempty,min=0,max=90"`
	SteeringWheelPosition  *float32   `json:"steering_wheel_position,omitempty" validate:"omitempty,min=0,max=999.9"`
	LeftMirrorAngle        *float32   `json:"left_mirror_angle,omitempty" validate:"omitempty,min=0,max=90"`
	RightMirrorAngle       *float32   `json:"right_mirror_angle,omitempty" validate:"omitempty,min=0,max=90"`
	RearviewMirrorAngle    *float32   `json:"rearview_mirror_angle,omitempty" validate:"omitempty,min=0,max=90"`
	CabinTemperature       *float32   `json:"cabin_temperature,omitempty" validate:"omitempty,min=15,max=35"`
